...
var russian = map[string]string{
	...
	"Eat one: restores health.":                                            "Съесть: восстанавливает здоровье.", "Drink one: stat buff or shield for 20 turns.": "Выпить: усиление или щит на 20 ходов.",
	...
	"Stat buff or shield for 20 turns.":               "Усиление или щит на 20 ходов.",
	...
	"YOUR PLACE": "ВАШЕ МЕСТО", "%d gold short of the top 10": "До топ-10 не хватило %d золота",
	...
	"STR": "СИЛ", "AGI": "ЛОВ", "HP": "ОЗ", "MAX HP": "МАКС ОЗ", "MHP": "МОЗ", "SHIELD": "ЩИТ", "SHLD": "ЩИТ",
