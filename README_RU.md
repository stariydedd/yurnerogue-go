...
| Оружие | Экипируется через `H`; прежнее оружие падает на свободную соседнюю клетку комнаты, коридора или дверного проёма. Если места рядом нет, оно возвращается в рюкзак. |
